...
object CreativeBriefing {
    ...
    const val INTENT_RULE = "\n[브리핑 해석] 사용자 브리핑은 확정된 설정이 아니라 구상·의도·후보를 포함한다. 부정·추측·정도·비교·범위·모호함을 보존한다. 명시적인 자기 정정은 마지막 발언을 참고하되 범위를 임의의 단일 값으로 확정하지 마라. sourceEvidence에는 제공된 브리핑·해당 필드의 보완 지시·참고자료의 정확한 원문만 적고 sourceType으로 구분한다. suggestionNote의 선택적인 창작 메모는 사실·검증·confidence의 근거가 아니다."
