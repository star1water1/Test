...
enum class SpeechError(val message: String) {
    ...
    FILE("녹음 파일을 읽을 수 없습니다. 기존 파일은 지우지 않았습니다. 보관한 녹음 목록을 확인하세요."),
    TOO_LARGE("녹음이 현재 전송 한도를 넘었습니다. 원본은 보관했습니다. 보관한 녹음 목록에서 확인하세요."),
    EMPTY("인식된 말이 없습니다. 마이크와 녹음 내용을 확인한 뒤 다시 시도하세요."),
    RESPONSE_TOO_LARGE("전사 응답이 읽기 한도를 넘었습니다. 잘린 응답을 사용하지 않았고 원본 녹음은 보관했습니다. 제공자의 응답 형식을 확인한 뒤 재시도하세요."),
