...
| 버전 | 날짜 | 변경 |
|------|------|------|
| v1.4 | 2026.07.31 | **2026.07.31 원칙 감사 반영** — 5장 표 갱신: GRADE 고정 행 취소선(B-69·U-1로 수리, 1-x·1-y장), 실재 재확인 6건 비고(밀도 바 · 사건 CALCULATED 표시 · 세계관 편집 무통보 폐기(+검사 사각 B-76) · 랭킹 카드 미배선 · 관계 통계 죽은 코드 · 사건 필드 모수) |
