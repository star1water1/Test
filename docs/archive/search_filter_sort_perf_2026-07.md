...
> **상태: 구현 완료** (2026-07-28 코드 재확인) — `CharacterViewModel`에 Room `InvalidationTracker`
> 기반 에폭 무효화와 스테이지드 메모이제이션이 실재한다(`:169~207`). 이 문서는 **왜 그렇게 됐는지**의
> 근거로 읽을 것이며, 새 성능 판단의 진입점은 `docs/scalability_performance_2026-07.md`다.
