...
- AI 창작 안정화 M1~M8과 보관 녹음 정리 [#410](https://github.com/star1water1/Test/pull/410)은 master에 반영됐다. 사용량은 새 성공 응답부터 텍스트 모델별 토큰·요청 당시 사용자 단가와 음성 전사 날짜/제공자/모델별 시간으로 구분한다. 이전 기록의 모델·당시 단가는 추정하지 않는다. 다음 단계는 노트20·Android 13의 [실기기 워크스루](device_walkthrough.md) 및 [M3 실기기 gate](creative_ai_voice_plan.md#실사용-안정화-m3--서비스-녹음과-중단-복구) 회신이며, 아직 항목별 확인은 없다. 온디바이스 인식은 사용자 회신상 미지원이다.
